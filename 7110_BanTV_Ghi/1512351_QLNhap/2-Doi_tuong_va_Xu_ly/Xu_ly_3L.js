...
function Xu_ly_cap_nhat(){
    ...
    Don_gia_nhap_moi.style.cssText = 'font-size: 25px; margin-left: 550px; color:#ee7915;font-weight: bold'
    ...
    Input_Ten_san_pham.style.cssText = 'font-size: 20px;width:350px; margin-left: 200px'
...
function Cap_nhat_gia(){
    ...
    else if(isNaN(parseFloat(Gia_moi)) == true || parseFloat(Gia_moi)<0)
...
function Tao_nut_Xem(){
    var Tao_nut_Xem = document.createElement("button")
    Tao_nut_Xem.innerHTML = "DANH SÁCH TV"
    Tao_nut_Xem.id = "btn_quay_ve"
    Tao_nut_Xem.onclick = function() {Xem_Danh_sach()}
    return Tao_nut_Xem
}
